(function( $, undefined ) {
    ...
    inline: false
      ...
      _create:function(){
        var calendar, interval, _func,
          that = this;
		if(_func=this.element.data().beforeshowday) this.options.beforeShowDay = window[_func];
		if(dateformat=this.element.data().dateformat) this.options.dateFormat = dateformat;
